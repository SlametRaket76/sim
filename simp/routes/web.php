...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('/confirmation/create', 'User\ConfirmationController@create')->name('user.confirmation.create');
    Route::get('/confirmation/notification', 'User\ConfirmationController@create')->name('user.confirmation.notification');
    Route::post('/confirmation/create', 'User\ConfirmationController@store')->name('user.confirmation.store');
