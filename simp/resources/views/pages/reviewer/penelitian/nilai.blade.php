                        ...
                        <form action="{{ route('reviewer.penelitian.pdf', $penelitian->id) }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input class="form-control {{ $errors->has('tema')?'is-invalid':''}}" type="text"
                                        name="tema" value="{{old('tema')}}">
                                    @if($errors->has('tema'))
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" readonly name="judul" value="{{ $penelitian->judul }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label for="example-email-input">Biaya yang Diusulkan</label>
                                    <input class="form-control {{ $errors->has('biaya_usul')?'is-invalid':''}}"
                                        type="text" name="biaya_usul" readonly
                                        value="{{old('biaya_usul', $penelitian->nominal)}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($errors->has('biaya_rekomendasi'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <table class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle"><input class="form-control" name="nilai_1" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_2">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_3">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <p>c. Pengayaan bahan ajar/ HAKI</p>
                                        </td>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_4">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_5">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_6">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        ...
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_7">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="center" class="align-middle">
                                            <h6>Jumlah</h6>
                                        </td>
                                        <td colspan="2" class="align-middle" id="bobot_8">100</td>
                                        <td class="align-middle"><input readonly class="form-control" name="nilai_8">
                                        </td>
                                    </tr>

                                    <tr>
                                        <td colspan="3" align="center" class="align-middle">
                                            <h6>Dana</h6>
                                        </td>
                                        <td colspan="2" class="align-middle"><input readonly class="form-control"
                                                name="nilai_9"></td>
                                    </tr>
                            ...
                            <td>
                                ...
                                <p> -> < 2.99=Tidak Lolos</p> </td> <div class="form-group float-right">
